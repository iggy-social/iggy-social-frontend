      ...
      <div class="d-flex justify-content-center">
        <div class="col-12 col-lg-8">
          <p class="text-break text-center mt-3 mb-4">
            Search for a domain and get its Friend Key to unlock a chat room with the domain holder and other key
            holders.
          </p>
  ...
  <div v-if="buyKeyToChat" class="card border mt-3 scroll-500">
    <div class="card-body">
      ...
      <div class="d-flex justify-content-center">
        <div class="col-12 col-lg-8">
          <p class="text-break text-center mt-3 mb-4">
            The chat is open only for key holders. Buy a key to see the chat and talk with the domain holder and other
            key holders.
          </p>
        </div>
      </div>
