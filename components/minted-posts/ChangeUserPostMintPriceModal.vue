      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p v-if="!userHasCustomPrice">
            You currently do not have a custom price set up, so the price of minting your posts is the default post
            minting price of {{ defaultPostPrice }} {{ $config.tokenSymbol }}.
          </p>
          ...
          <div class="row">
            ...
            <small
              ><em
                >If you set it to 0, the post mint price will be the default price of {{ defaultPostPrice }}
                {{ $config.tokenSymbol }}</em
              ></small
            >
          </div>
        </div>
